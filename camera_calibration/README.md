...
```bash
./run_ui.sh --stage localization --auto-connect
```
...
验证程序会检查 PDF 是否为 ISO A4、ChArUco 方格是否为 `24.0 mm`、四个 Tag
...
```bash
_camera_info_url:=file:///home/throne/workspaces/arm/camera_calibration/output/astra_pro_rgb_1280x720.yaml
```
