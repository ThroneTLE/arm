...
def generate_rasters(output_dir: Path):
    ...
    board_path = output_dir / "charuco_7x10_preview_600dpi.png"
...
def draw_charuco_page(pdf, board_path: Path) -> None:
    ...
    pdf.drawString(
        8 * mm,
        20 * mm,
        "7 x 10 squares | square 24.0 mm | marker 18.0 mm | AprilTag 36h11",
    )
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="targets")
