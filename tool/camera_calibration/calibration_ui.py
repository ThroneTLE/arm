...
TARGET_PREVIEW = ROOT / "targets" / "charuco_5x7_large_preview_600dpi.png"
...
class CalibrationWindow(QMainWindow):
    ...
    def verify_finished(self, exit_code: int) -> None:
        ...
        if exit_code == 0:
            ...
            self.print_verify_status.setText("尺寸校验通过 · A4 / 36.0 mm / 70.0 mm / ID 100–103")
